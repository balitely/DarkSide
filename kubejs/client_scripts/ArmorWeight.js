ItemEvents.tooltip((event) => {
	event.add(
		...
		Text.translatable("text.kubejs.tooltips.verylight")
	);
	event.add(
		[
			//基础护甲
		...
		Text.translatable("text.kubejs.tooltips.light")
	);
	event.add(
		[
			//基础护甲
		...
		Text.translatable("text.kubejs.tooltips.common")
	);
	event.add(
		[
			//基础护甲
		...
		Text.translatable("text.kubejs.tooltips.heavy")
	);
	event.add(
		["minecraft:diamond_helmet", "minecraft:diamond_chestplate", "minecraft:diamond_leggings", "minecraft:diamond_boots"],
		Text.translatable("text.kubejs.tooltips.veryheavy")
	);
	event.add(
		["composite_material:obsidian_helmet", "composite_material:obsidian_chestplate", "composite_material:obsidian_leggings", "composite_material:obsidian_boots"],
		Text.translatable("text.kubejs.tooltips.extremelyheavy")
	);
});
