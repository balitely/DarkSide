ServerEvents.tags("item", (event) => {
	...
	let Tool_N_Weapons = [
		...
		//convertible_into_magicartifact
		//基础武器
		"minecraft:lantern",
	...
	event.add("forge:armors/helmets", head);
	event.add("forge:armors/chestplates", body);
	event.add("forge:armors/leggings", legs);
	event.add("forge:armors/boots", boots);
	event.add("kjs:tools", Tool_N_Weapons);
});
